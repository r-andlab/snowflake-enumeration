...
const (
	caidaIPv4File = `/home/ubuntu/prefix-data/routeviews-rv2-20250310-1200.pfx2as`
	caidaIPv6File = `/home/ubuntu/prefix-data/routeviews-rv6-20250312-1200.pfx2as`
)
...
func (bc *BrokerChannel) SetNATType(NATType string) {
	...
	bc.lock.Lock()
	//bc.natType = NATType //original implementation
	bc.natType = hardcodedNATType //new hardcoded implementation
	bc.lock.Unlock()
	// logging
